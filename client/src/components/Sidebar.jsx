...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { label: 'ATS Score', icon: <BarChart size={18} />, to: '/dashboard/ats-score' },
  ...
  return (
    <div className={`h-screen ${isOpen ? 'bg-white' : 'bg-gray-100'} shadow-lg relative top-0 left-0 z-50 translate-all duration-300 ${isOpen ? 'w-64' : 'w-20'}`}>
      {isOpen ? (
        <>
          ...
          <h1 className="text-xl font-bold ml-5 mt-6 mb-5 text-purple-700">Job Recommender AI</h1>
        </>
      ) : (
